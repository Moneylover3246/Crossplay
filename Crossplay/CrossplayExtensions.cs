...
namespace Crossplay
{
    public static class CrossplayExtensions
    {
        ...
        /// <param name="array">The buffer used to insert the swapped bytes<paramref name="newBuffer"/></param>
        /// <param name="start">The start position of the value swap</param>
        /// <param name="length">The amount of bytes to read</param>
        /// <param name="newBuffer">The buffer to copy the values from</param>
